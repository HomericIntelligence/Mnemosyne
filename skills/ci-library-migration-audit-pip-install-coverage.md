...
description: "Find missing CI dependencies after moving Python helpers to an installed library. Use for environment-manager bypasses, missing installs, and divergent version pins."
category: ci-cd
date: 2026-05-24
version: "1.0.1"
