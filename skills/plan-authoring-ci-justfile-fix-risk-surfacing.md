...
description: "Plan fixes for CI recipes that pass locally by checking the actual caller, selected inputs, tool provenance, and unverified root-cause assumptions."
category: ci-cd
date: 2026-06-20
version: "1.1.0"
...
history-source: "https://github.com/HomericIntelligence/Mnemosyne/blob/e98a4da5d67f0766bc6b4bfaed1ab399fca90e9f/skills/plan-authoring-ci-justfile-fix-risk-surfacing.history"
...
> root-cause claim is `unverified` against the failing CI run. Use current source
> and available logs to choose the repair; report missing evidence explicitly.
