...
history-source: "https://github.com/HomericIntelligence/Mnemosyne/blob/ed1bd4f54fd4aaba446af92c8b3ab9aff2589ae3/skills/python-repo-modernization-workflow.history"
...
When useful, consult an available Hephaestus checkout through Athena's dependency-resolution contract. Record its revision and any limits; an unavailable reference does not block target-repository work. Adapt patterns to the target's package layout, commands, and publication model.
...
5. Align tests with behavioral boundaries. Prefer focused unit/error tests and integration or installed-artifact checks that catch distinct failures.
...
8. Reuse existing pre-commit and CI checks. Add enforcement only when the modernization requirements call for it.
