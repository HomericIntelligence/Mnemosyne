# Campaign Handoff: Original Case Examples

Historical prompt examples from the recorded serial campaign. These are evidence of
the original workflow, not current general instructions.
