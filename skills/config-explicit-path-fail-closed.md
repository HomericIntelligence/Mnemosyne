...
description: "Preserve explicit-path errors in layered configuration loading. Use when missing user-selected paths fall through to defaults or tests use fake paths to disable discovery."
...
tags:
  ...
  - runtime-error
  - fleet-sync
history-source: "https://github.com/HomericIntelligence/Mnemosyne/blob/ed1bd4f54fd4aaba446af92c8b3ab9aff2589ae3/skills/config-explicit-path-fail-closed.history"
